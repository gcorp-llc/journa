<header id="main-header" class="fixed top-0 left-0 right-0 z-50 font-vazir ">
    <div id="header-content" class="flex justify-between items-center p-2 rounded-xl shadow-lg m-2 transition-all duration-300 ease-out bg-slate-800/60 backdrop-blur-sm">
        ...
        <div class="flex items-center gap-4">
            <div class="drawer drawer-start">
                ...
                <div class="drawer-content">
                    <label for="my-drawer" class="btn btn-ghost btn-circle text-white">
