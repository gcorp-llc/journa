<a href="{{ url(app()->getLocale() . '/news/' . $news->slug) }}" class="block" aria-label="{{ $news->title }}">
    <div class="card bg-white/70 backdrop-blur-md glass shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl overflow-hidden">
